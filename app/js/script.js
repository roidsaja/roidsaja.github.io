...
const popUpItems = [".about", ".experiences", ".project__header", ".project__item", ".contact"];
...
const tabs = document.querySelectorAll(".experiences__tabs > .tab");
...
function handleTabClick(e) {
    ...
    const activeTab = document.querySelector(".experiences__tabs .active");
    const activeContent = document.querySelector(".experiences__content .visible");
    const currentContent = document.querySelector(`.experiences__content_section[data-tab='${tabNum}']`);
...
copyEmailBtn.addEventListener("click", (e) => {
    navigator.clipboard.writeText("roid0520@gmail.com").then(
        () => {
